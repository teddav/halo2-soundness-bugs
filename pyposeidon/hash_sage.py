...
# poseidon_simple, t = poseidon.parameters.case_neptune()
...
print(hex(poseidon_custom.run_hash([1, 2, 3])))
# print(hex(poseidon_custom.run_hash([0, 2, 1])))
# print(hex(poseidon_custom.run_hash([0, 1, 2])))
